...
alias nuke-node-modules="find . -name 'node_modules' -type d -prune -exec rm -rf '{}' + "
alias nukeshakti="cd ~/github/shakti;nuke-node-modules && rm -rf tmp generated ; "
...
alias m1-rm-nodemodules="cd ~/github/shakti && nuke-node-modules"
alias m1-clean="npx gulp clean"
alias m1-nuke="git clean -xfd"
alias m1-nginx="newt exec gulp nginx"
alias m1-install="cd ~/github/shakti && npm install && cd test/functional && npm install"
